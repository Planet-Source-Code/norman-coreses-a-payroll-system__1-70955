   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Engcore Merchandising Payroll System"
         Alignment       =   2
      EndProperty
      ItemType2       =   3
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Date of payslip:"
      EndProperty
      ItemType3       =   3
...
Private Sub DataReport_Initialize()
    ...
    With Me.Sections("SECTION4").Controls
        .Item("LABEL20").Caption = Form16.ListView1.SelectedItem.SubItems(18)
        .Item("LABEL36").Caption = Form16.Text1.Text
    End With
    
    With Me.Sections("SECTION5").Controls
        .Item("LABEL31").Caption = Form16.Label3.Caption
        .Item("LABEL32").Caption = Form16.Label5.Caption
    End With
